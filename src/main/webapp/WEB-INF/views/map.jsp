...
<%@ include file="header.jsp" %>
  ...
  <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=982f4155446da3a3024b8cfac00d35cc&libraries=services"></script>
	<script>
